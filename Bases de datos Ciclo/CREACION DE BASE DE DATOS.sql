...
(
	...
	IMAGEPRODUCT		IMAGE NOT NULL,				--	IMAGEN DEL PRODUCTO
...
--=======================================================================================>
/*	SE CREA LA TABLA DONDE SE ALMACENARAN LAS BODEGAS									*/
--=======================================================================================>
CREATE TABLE WAREHOUSE 
(
	IDWAREHOUSE			BINARY(16) NOT NULL,		--LLAVE PRIMARIA DE LA TABLA 
	REFERENCEWAREHOUSE	INT NOT NULL,				--CODIGO DE LA BODEGA QUE CONOCE EL USUARIO
	NAMEWAREHOUSE		VARCHAR(45)NOT NULL,		--NOMBRE DE LA BODEGA
	MANAGERHAREHOUSE	BINARY(16)NOT NULL,			--TODAS LAS BODEGAS DEBEN TENER UN ENCARGADO, ESTE DEBE ESTAR REGISTRASDO EN LA TABLA DE USUARIOS
	ADDRESSWAREHOUSE	VARCHAR(50)NOT NULL,		--DIRECCION DE LA BODEGA
	STATUSWAREHOUSE		CHAR(1)NOT NULL,			--ESTADO DE LA BODEGA 'A'CTIVA | 'I'NACTIVA
	IDUSER				BINARY(16)NOT NULL,			--USUARIO QUE MODIFICA 
	UPDATETIMESTAMP		DATETIME NOT NULL,			--FECHA Y HORA EN LA CUAL SE EDITO | CREO EL REGISTRO
	STATUS				CHAR(1) NOT NULL,			--ESTADO DEL REGISTRO 'C'|'M'
)

-- SE CREA LA LLAVE PRIMARIA DE LA TABLA WAREHOUSE
ALTER TABLE WAREHOUSE ADD CONSTRAINT PK_WAREHOUSE PRIMARY KEY(IDWAREHOUSE)

-- SE CREA LA LLAVE FORANEA DE LA TABLA DE USUARIOS PARA EL MANAGERWAREHOUSE
ALTER TABLE WAREHOUSE ADD CONSTRAINT FK1_USERS FOREIGN KEY (MANAGERHAREHOUSE) REFERENCES USERS(IDUSER) 